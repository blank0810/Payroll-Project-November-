...
{
    public partial class slipList : UserControl
    {
        ...
        public slipList(int userId, listUC parent)
        {
            InitializeComponent();
            _userId = userId;
            _parent = parent;
        ...
        // Custom function for binding values
        ...
        private void slipList_Load(object sender, EventArgs e)
        {
            DataBinding();
        }
