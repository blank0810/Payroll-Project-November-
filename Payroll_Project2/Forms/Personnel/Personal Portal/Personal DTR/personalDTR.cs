...
using Payroll_Project2.Forms.Personnel.Personal_Portal.Personal_DTR.DTR_sub_user_control;
using System;
using System.Data;
...
namespace Payroll_Project2.Forms.Personnel.Personal_Portal.Personal_DTR
{
    public partial class personalDTR : UserControl
    {
        ...
        public personalDTR(int userId, newDashboard parent)
        {
            InitializeComponent();
            _userId = userId;
            _parent = parent;
