...
using Payroll_Project2.Forms.Department_Head.Personal_Portal.File_Travel_Order.File_Travel_Order_sub_user_control;
using System;
...
namespace Payroll_Project2.Forms.Department_Head.Personal_Portal.File_Travel_Order
{
    public partial class fileTravelOrderUC : UserControl
    {
        ...
        public fileTravelOrderUC(int userId, departmentHeadDashboard parent, string department)
        {
            InitializeComponent();
            _userId = userId;
            _parent = parent;
