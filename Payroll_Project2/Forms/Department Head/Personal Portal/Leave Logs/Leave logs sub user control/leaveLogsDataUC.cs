...
using Payroll_Project2.Forms.Department_Head.Personal_Portal.Leave_Logs.Modals;
using System;
...
namespace Payroll_Project2.Forms.Department_Head.Personal_Portal.Leave_Logs.Leave_logs_sub_user_control
{
    public partial class leaveLogsDataUC : UserControl
    {
        ...
        public leaveLogsDataUC(int userId, leaveLogsUC parent)
        {
            InitializeComponent();
            _userId = userId;
            _parent = parent;
