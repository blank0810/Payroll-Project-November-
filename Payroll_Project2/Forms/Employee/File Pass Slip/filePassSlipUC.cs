...
using Payroll_Project2.Forms.Employee.File_Pass_Slip.File_Pass_Slip_sub_user_control;
    ...
    public partial class filePassSlipUC : UserControl
    {
        ...
        private async Task DisplaySlipHours()
        {
            try
            {
                ...
                for (int i = 0; i < 5;  i++)
                {
                    passSlipDataUC slipDataUC = new passSlipDataUC();
                    listHoursPanel.Controls.Add(slipDataUC);
                }
        ...
        private async void submitBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                await _parent.DisplayFilePassSlip();
            }
            catch (SqlException sql)
            {
