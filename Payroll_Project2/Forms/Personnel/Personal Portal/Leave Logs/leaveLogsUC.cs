...
namespace Payroll_Project2.Forms.Personnel.Personal_Portal.Leave_Logs
{
    public partial class leaveLogsUC : UserControl
    {
        ...
        private newDashboard _parent;
        private static int _year = DateTime.Now.Year;
        private static generalFunctions generalFunctions = new generalFunctions();

        public leaveLogsUC(int userId, newDashboard parent)
        {
            InitializeComponent();
            _userId = userId;
            _parent = parent;
        ...
        public async Task DisplayLeave(int employeeId)
        {
            try
            {
                ...
                if (list != null && list.Rows.Count > 0)
                {
                    ...
                    {
                        leaveLogs[i] = new leaveLogsDataUC(_userId, this, employeeId);
