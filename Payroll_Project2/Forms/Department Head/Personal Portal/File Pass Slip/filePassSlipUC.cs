...
using Payroll_Project2.Forms.Department_Head.Personal_Portal.File_Pass_Slip.File_Pass_Slip_sub_user_control;
using System;
...
namespace Payroll_Project2.Forms.Department_Head.Personal_Portal.File_Pass_Slip
{
    public partial class filePassSlipUC : UserControl
    {
        ...
        public filePassSlipUC(int userId, departmentHeadDashboard parent, string department)
        {
            InitializeComponent();
            _userId = userId;
            _parent = parent;
