...
namespace Payroll_Project2.Forms.System_Administrator.Employee_Management.Modal
{
    public partial class appointmentForm : Form
    {
        ...
        private static appointmentListUC _parent;
        ...
        public appointmentForm(int userId, appointmentListUC parent)
        {
            InitializeComponent();
            _userId = userId;
            _parent = parent;
        ...
        private async Task DataBinding()
        {
            try
            {
                ...
                employmentStatus.SelectedItem = EmploymentStatus;
        ...
        private async Task<bool> AddEmployee(string password, string employeePicture, string employeeSignature)
        {
            ...
            {
                employeeClass employeeClass = new employeeClass();
                bool addEmployee = await employeeClass.AppointEmployee(password, accountStatus, FirstName, LastName, MiddleName, Birthday,
