...
using Payroll_Project2.Forms.Department_Head.Personal_Portal.File_leave.File_leave_sub_user_control;
using System;
...
namespace Payroll_Project2.Forms.Department_Head.Personal_Portal.File_leave
{
    public partial class fileLeaveUC : UserControl
    {
        ...
        public fileLeaveUC(int userId, departmentHeadDashboard parent, string department)
        {
            InitializeComponent();
            _userId = userId;
            _parent = parent;
