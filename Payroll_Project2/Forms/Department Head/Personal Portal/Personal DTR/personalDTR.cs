...
using Payroll_Project2.Forms.Department_Head.Personal_Portal.Personal_DTR.DTR_sub_user_control;
using System;
using System.Data;
...
namespace Payroll_Project2.Forms.Department_Head.Personal_Portal.Personal_DTR
{
    public partial class personalDTR : UserControl
    {
        ...
        public personalDTR(int userId, departmentHeadDashboard parent)
        {
            InitializeComponent();
            _userId = userId;
            _parent = parent;
